...
import com.google.ar.core.GeoMap
...
class HelloGeoRenderer(val activity: HelloGeoActivity) :
    ...
    override fun onSurfaceCreated(render: SampleRender) {
        ...
        try {
            ...
            if (session != null) {
                ...
                val startAnchor = resolveAnchor(
                    session!!,
                    geoMap.startPointLatLng.latitude,
                    geoMap.startPointLatLng.longitude,
                    16.0
                )
                val endAnchor = resolveAnchor(
                    session!!,
                    geoMap.endPointLatLng.latitude,
                    geoMap.endPointLatLng.longitude,
                    16.0
                )
                ...
                if (startAnchor != null && endAnchor != null) {
                    ...
                    Log.e(TAG, "Some of line anchors is null")
                }
    ...
    fun resolveAnchor(
        ...
        //if (earth?.trackingState == TrackingState.TRACKING) {
            // Asynchronously resolve an anchor on the terrain.
